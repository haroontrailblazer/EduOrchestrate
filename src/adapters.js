...
function adapterManifest(agentName) {
  return `${JSON.stringify({
    ...
    capabilities: ["onboarding", "token-conscious-harness", "role-course-sources", "adaptive-plan-minimum-30-days", "first-skill-focus", "trend-research-digest", "daily-email", "progress-log", "progression-card", "terminal-card-svg", "weekly-summary", "next-skill-recommendation", "setup-diagnostics"],
...
function mcpManifest() {
  return `${JSON.stringify({
    ...
    tools: ["eduorchestrate_onboard", "eduorchestrate_harness", "eduorchestrate_courses", "eduorchestrate_plan30", "eduorchestrate_research", "eduorchestrate_send_today", "eduorchestrate_log_progress", "eduorchestrate_progress_card", "eduorchestrate_terminal_card", "eduorchestrate_weekly_summary", "eduorchestrate_recommend_next", "eduorchestrate_status"]
  }, null, 2)}\n`;
}
